# PMM Gate 4: Pricing Strategy

Pricing models, competitive pricing analysis, willingness-to-pay validation, and packaging.

---

## Pricing Strategy (from pricing-strategy skill)
...
| "Model pricing scenarios" | Scenario analysis with revenue projections, sensitivity tables, and break-even comparison |
...
- **copywriting.md** — 轉換文案、內容策略。原 copywriting + content-strategy skill。Use for pricing page copy polish. NOT for pricing structure or tier design.
- **retention.md** — 留客與流失防堵。原 churn-prevention skill。Use when churn is the underlying issue — fix retention before raising prices.
- **competitive-content.md** — 競品頁面與行銷心理學。原 competitor-alternatives + marketing-psychology skill。Use competitor-alternatives 區段 for competitive comparison pages that complement pricing pages.
