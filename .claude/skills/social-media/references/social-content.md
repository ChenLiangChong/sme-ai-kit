...
Social media content creation, calendar planning, and community management.
...
|----------|----------|-----------|------------|
| Facebook | Communities, local businesses, 35+ audiences | 1-2x/day | Groups, native video, 限動 |
| Instagram | Visual brands, lifestyle, younger audiences | 1-2 posts + Stories daily | Reels, carousels |
| Threads | Text-based engagement, brand personality | 3-5x/week | Short text, conversations |
| LINE VOOM | LINE ecosystem content, existing followers | 2-3x/week | Images, short video, articles |
| YouTube | Education, tutorials, long-form | 1-2x/week | Videos, Shorts |
| TikTok | Brand awareness, younger audiences | 1-3x/day | Short-form video |
| LinkedIn | B2B, thought leadership | 3-5x/week | Carousels, articles |
...
| Platform | Format |
|----------|--------|
| Facebook | Key insight + link in comments |
| Facebook | Carousel of main points |
| Instagram | Carousel with visuals |
| Instagram | Reel summarizing the post |
| Threads | Key takeaway thread |
| LINE VOOM | Summary image + link |
...
| Day | Facebook | Instagram | Threads |
|-----|----------|-----------|---------|
| Mon | Industry insight | Carousel | Key takeaway |
| Tue | Behind-scenes | Story | Engagement post |
| Wed | Educational | Reel | Tips |
| Thu | Story post | Educational | Discussion |
| Fri | Hot take / poll | Story | Engagement |

### Batching Strategy (2-3 hours weekly)

1. Review content pillar topics
2. Write 5 Facebook posts
3. Write 3 Threads posts + Instagram captions
...
- **marketing-ops.md** — 行銷路由與上下文建構。原 marketing-context + marketing-ideas + marketing-ops skill。USE as foundation before creating any content — loads brand voice, ICP, and tone guidelines.
- **copywriting.md** — 轉換文案、內容策略。原 copywriting + content-strategy skill。USE copywriting 區段 for long-form page or landing page copy; USE content-strategy 區段 when deciding what topics to cover. NOT for short-form social posts.
- **copy-editing.md** — 七步 copy editing 框架。USE to polish social copy drafts, especially for high-stakes campaigns. NOT for casual post creation.
- **content-production.md** — 內容生產與 AI 人性化。原 content-production + content-humanizer skill。USE for high-volume content or when AI-drafted posts sound robotic. NOT for strategy or scheduling.
- **pmm-launch.md** — 產品上市執行。原 launch-strategy skill（已合併）。USE when coordinating social content around a product launch. NOT for evergreen posting schedules.
...
|----------|----------|---------------|-----------------|
| **Facebook** | 35+ audiences, communities, local businesses | Posts, groups, native video, 限動 | 1-2x/day |
| **Instagram** | Visual brands, lifestyle, younger audiences | Reels, stories, carousels | 4-7x/week |
| **Threads** | Text-based engagement, brand personality | Short text, conversations | 3-5x/week |
| **LINE VOOM** | LINE ecosystem, existing customer base | Images, short video, articles | 2-3x/week |
...
| **LinkedIn** | B2B, thought leadership | Long-form posts, carousels, articles | 3-5x/week |
...
|--------|-------------------|--------|
| Engagement rate | Content resonance | >1% (Facebook), >2% (Instagram), >3% (Threads) |
...
- 見本檔案上方的 social-content 區段 — For writing individual social posts. NOT for strategy (that's this section).
- **social-analytics.md** — 社群分析與成長。原 social-media-analyzer + x-twitter-growth skill。For analyzing social media performance data.
- **copywriting.md** — 轉換文案、內容策略。原 copywriting + content-strategy skill。For landing pages, web copy, and broader content planning that feeds into social.
- **marketing-ops.md** — 行銷路由與上下文建構。原 marketing-context + marketing-ideas + marketing-ops skill。Foundation — reads brand voice for consistent social tone.
- **paid-acquisition.md** — 付費廣告策略與創意。原 ad-creative + paid-ads skill。For paid social ad copy, distinct from organic social content.
