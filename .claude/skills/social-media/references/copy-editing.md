...
Seven-sweep copy editing framework and quick-pass editing checks.
...
- **marketing-ops.md** — 行銷路由與上下文建構。原 marketing-context + marketing-ideas + marketing-ops skill。USE as foundation before editing — provides brand voice, ICP, and tone benchmarks.
- **copywriting.md** — 轉換文案、內容策略。原 copywriting + content-strategy skill。USE copywriting 區段 when the copy needs to be rewritten from scratch; USE content-strategy 區段 when the problem is what to say, not how to say it. NOT for line-level improvements.
- **social-content.md** — 社群內容創作與管理。原 social-content + social-media-manager skill。USE when edited copy needs to be adapted for social platforms. NOT for page-level editing.
- **content-production.md** — 內容生產與 AI 人性化。原 content-production + content-humanizer skill。USE content-humanizer 區段 when AI-generated copy needs to pass the human test before copy editing begins. NOT for structural review.
