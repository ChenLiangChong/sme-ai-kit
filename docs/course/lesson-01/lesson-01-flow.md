...
| **不涵蓋** | 個人助理（第二堂主題）、LINE 接客服 + 自動化（第三堂主題） |
...
| 25-27 min | 交付 + 學員打開成品 | 引導 1-2 位學員練習「跟 Claude 對話改成品」 |
...
### 當 Claude 交付成品後（學員互看 + 老師引導）

**老師要做的**：
- 邀 1-2 位自願學員螢幕分享他們的 PPT
- **引導討論（不是點評內容）**：
  - 老師不需要懂學員的產業——每家公司情況不同，老師不可能都通；這堂課不是「老師教行銷」
  - 引導問法：「你看完這份哪裡想改？」「哪一頁感覺還不到位？」
  - 接著引導：「那你**要怎麼跟 Claude 說**它才改得到你要的？」
  - 現場示範 1 次「學員 → Claude」的修改對話，讓其他學員看懂「怎麼跟 AI 討論」
- **事先套招**（🔴 合作者決定）：找 2 位事前測試過的學員先分享，他們的成品品質較穩、帶起分享氣氛
...
| 這套會不會很貴？ | 入門門檻是 Claude Max $100 美金／月——對中小企業老闆來說，一個月就抵一份顧問報告的百分之一 |

**下集預告 口白**：
> 「各位今天做到了什麼？你拿到了**你自己公司**的顧問級行銷分析簡報——12 頁、完整、可以直接拿去會議用。這份找顧問公司做要 5 萬 + 2 週、你今天 30 分鐘就有了。
>
> 下一堂會把 Claude 變成**你的個人助理**——它會記得你公司的事、追你的進度、幫你處理那些每次都要從零解釋的重複溝通。你不用再從空白 chat 開始。
>
> 再下一堂才接 **LINE**——讓 Claude 代你值班、客人問價它直接回、你早上醒來再看昨晚它做了什麼。
>
> 你今天拿到的是**顧問報告**；下一堂拿到的是**記得你的 AI 分身**；第三堂拿到的是**24 小時上班的 AI 員工**。
>
> 請把今天的 PPT 存好。下一堂再見。」
...
2. **學員 Claude 方案**：**至少 Claude Max $100 美金／月**——這是入門門檻，免費與基本 Pro 都不足。報名資訊要明確告知
...
- **為什麼分三堂**：第一堂產出（顧問級分析）= 技能與成品價值；第二堂個人助理（Claude 記得你、追進度）= 時間價值；第三堂 LINE 自動化 = 規模價值。每堂降低門檻、階梯式升級。LINE 涉及 token / ngrok / server 配置，絕對不是第一堂可以消化。
