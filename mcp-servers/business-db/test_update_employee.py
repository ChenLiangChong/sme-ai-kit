...
def setup():
    ...
    result = register_employee("老闆", role="boss", department="管理部", permissions="admin", phone="0912-000-001")
    print(f"✓ 建立測試員工: {result}")

    result = register_employee("Test 員工", role="staff", department="倉管", permissions="basic", phone="0912-000-002")
    print(f"✓ 建立測試員工: {result}")

def test_update_name():
    result = update_employee(1, name="老闆 Chen")
